						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button"><a href="#"></a></div>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								...
								main_nav">
									...
									<li ><a href="gestion-documents.html">Gestion documents</a></li>
									<li class="active" ><a href="#">Liste des documents</a></li>
								...
								<div class="footer_section footer_links">
									...
									<div class="footer_links_container">
										<ul>
											...
											<li><a href="gestion-documents.html">Gestion documents</a></li>
											<li><a href="contact.html">Contact</a></li>
											<lic><a href="liste-des-documents.html">liste-des-documents</a></li>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | disigner  <i class="fa fa-heart-o" aria-hidden="true"></i> Jacqeline Nkouotou <a href="https://colorlib.com" target="_blank">Colorlib</a>
