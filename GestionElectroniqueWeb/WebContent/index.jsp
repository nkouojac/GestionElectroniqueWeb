						...
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title">GESTION ELECTRONIQUE DES DOCUMENTS PERSONNELS</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">BIENVENUE DANS MON APPLICATION DE GESTION ELEGTRONIQUE DES DOCUMENTS PERSONNELS</h2>
						<div class="section_subtitle"><p>Cette application a été  crée pour eviter des problèmes tels que :les pertes des documents,les destructions des documents. La perte d'énergie ,d'argent et du temps dans la recherche des doccuments </p></div>
					</div>
				</div>
			</div>
			<div class="row features_row">
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<!--000000000<h3 class="feature_title">Book & Library</h3> --> 
						<!--<div class="feature_text"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p></div>-->
					</div>
				</div>
				...
				<div class="row fill_height">
					<div class="col fill_height">
						<form class="counter_form_content d-flex flex-column align-items-center justify-content-center" action="#">
							<div class="counter_form_title"> RECHERCHER UN DOCUMENT</div>
							...
							<button type="submit" class="counter_form_button">ok</button>
						</form>
					</div>
				</div>
			</div>
